  ...
  <div>
          ...
          <div class="custom-card active-card">
            ...
            <div class="card-header">
              <div
                class="tab-header"
                :class="{
                  'active-tab': isRondaAbierta,
                  'inactive-tab': !isRondaAbierta,
                }"
              >
            ...
            <div class="card-body p-4 text-center">
              <p class="card-text px-lg-5">
                ...
                <span v-else> No hay rondas abiertas para subir charlas. </span>
              </p>
              ...
              <button
                class="btn mt-2"
                :class="
                  isRondaAbierta && puedeSubirCharla
                    ? 'btn-primary'
          ...
          <div class="custom-card border-0 active-card">
            ...
            <div class="card-header border-0">
              <div
                class="tab-header"
                :class="{
                  'active-tab': isVotacionActiva,
                  'inactive-tab': !isVotacionActiva,
                }"
              >
            ...
            <div class="card-body p-4 text-center">
              <p class="card-text px-lg-5">
                ...
                <span v-else> No hay votaciones activas en este momento. </span>
              </p>
              ...
              <div class="d-flex justify-content-center mt-2">
                ...
                <button
                  class="btn ms-2 mt-2"
                  :class="
                    isVotacionActiva && puedeVotar
                      ? 'btn-primary'
                      : 'btn-secondary text-whiite'
                  "
        ...
        <div class="mb-3 mb-md-4 col-lg-8">
          ...
          <div>
            ...
            <p class="text-secondary small mt-2">
              <b>Nota:</b> Para ver los detalles de un día específico, haz clic
              en la parte de la casilla correspondiente a ese día.
            </p>
          </div>
        ...
        <div class="mb-4 ps-lg-2 col-12 col-lg-4">
          ...
          <div class="list-group pt-1">
            ...
            <div
              ...
              v-for="(evento, index) in mostrarTodos
                ? eventosPresentaciones
                : eventosPresentaciones.slice(0, 5)"
              :key="index"
            >
              <span
    ...
    <div class="container my-5 pb-4" v-if="role == 1 && !cargando">
      ...
      <div class="row mt-lg-4 mt-2 pt-3">
        ...
        <div class="col-12 col-lg-6 mb-4 mb-lg-0 pe-lg-4">
          ...
          <div class="list-group">
            ...
            <div
              v-if="presentacionesPendientes.length == 0"
            ...
            <div
              ...
              v-for="(evento, index) in mostrarTodos
                ...
                : presentacionesPendientes.slice(0, 4)"
              :key="index"
            >
              <span
              ...
              <small class="text-muted ms-3">
                ...
                <!-- Botón de edición -->
                <button
                  class="btn btn-primary btn-sm mt-0 ms-3"
                  @click="editarRonda(evento.idRonda)"
                >
            ...
            <!-- Botón "Ver más" o "Ver menos" -->
            <div
              v-if="presentacionesPendientes.length > 4"
              class="text-end mt-1"
            >
              <button class="btn btn-primary" @click="toggleMostrarTodos">
                {{ mostrarTodos ? "Ver menos" : "Ver más" }}
        ...
        <div
          ...
          :class="
            presentacionesPendientes.length > 4 ? 'mt-md-0' : 'mt-md-5 pt-2'
          "
        >
          <div
      ...
      <div class="button-container mb-3">
        <button class="btn btn-mover me-2" @click="mostrarGrafico('rondas')">
          Rondas
        </button>
        <button class="btn btn-mover me-2" @click="mostrarGrafico('alumnos')">
          Alumnos
        </button>
        <button
  ...
  methods: {
    handleDateClick(info) {
      ...
      if (this.calendarOptions.events.length > 0) {
        const eventsOnSelectedDate = this.calendarOptions.events.filter(
          (event) => {
            const eventStartDate = new Date(event.start || event.date); // Fecha de inicio
            const eventEndDate = event.end
              ? new Date(event.end)
              : eventStartDate; // Fecha de fin, si existe
        ...
        if (eventsOnSelectedDate.length > 0) {
          eventList = eventsOnSelectedDate
            .map((event, index) => {
              let eventType = "";
          ...
          serviceChar
            ...
            .then((charlasAlumno) => {
              ...
              serviceChar
                ...
                .then((votosAlumno) => {
                  ...
                  this.rondas.forEach((ronda) => {
                    ...
                    const fechaLimiteVotacion = new Date(
                      ronda.fechaLimiteVotacion + "Z"
                    );
                    const fechaPresentacion = new Date(
                      ronda.fechaPresentacion + "Z"
                    );

                    const fechaCierreDia = new Date(
                    ...
                    if (ahora < fechaCierreDia) {
                      ...
                      const charlaEnRonda = charlasAlumno.some(
                        (charla) => charla.charla.idRonda === ronda.idRonda
                      );
                    ...
                    if (ahora <= fechaLimiteVotacion) {
                      if (
                        ahora > fechaCierreDia &&
                        ahora <= fechaLimiteVotacion
                      ) {
                        isVotacionActiva = true;

                        // Verificar si el alumno ya votó en esta ronda
                        const votoEnRonda = votosAlumno.some(
                          (voto) => voto.idRonda === ronda.idRonda
                        );
                    ...
                    if (ahora <= fechaPresentacion) {
                      ...
                      this.eventosPresentaciones.sort(
                    ...
                    if (
                      ...
                      rondasPromises.push(
                        serviceChar
                          ...
                          .catch((error) => {
                            console.error(
                              "Error al obtener las charlas de la ronda:",
                              error
                            );
                          })
                      );
                ...
                .catch((error) => {
                  console.error(
                    "Error al obtener los votos del alumno:",
                    error
                  );
                  this.cargando = false;
                });
      ...
      const { isConfirmed, isDenied, value } = await Swal.fire({
        ...
        html: `
          <div style="text-align: left; display: flex; flex-direction: column; gap: 15px; width: 100%;">
            ...
            <input id="swal-descripcion" class="swal2-input m-0" style="width: 100%; box-sizing: border-box;" value="${
              ronda.descripcionModulo || ""
            }">
            <label for="swal-duracion">Duración (minutos): <span class="text-danger">*</span></label>
            <input id="swal-duracion" type="number" class="swal2-input m-0" style="width: 100%; box-sizing: border-box;" value="${
              ronda.duracion || ""
            }">
            ...
            <input id="swal-fechacierre" type="date" class="swal2-input m-0" style="width: 100%; box-sizing: border-box;" 
              value="${
                ronda.fechaCierre ? ronda.fechaCierre.split("T")[0] : ""
              }" 
            ...
            <input id="swal-fechalimitevotacion" type="date" class="swal2-input m-0" style="width: 100%; box-sizing: border-box;" 
              value="${
                ronda.fechaLimiteVotacion
                  ? ronda.fechaLimiteVotacion.split("T")[0]
                  : ""
              }" 
              min="${
                ronda.fechaCierre
                  ? ronda.fechaCierre.split("T")[0]
            ...
            <input id="swal-fechapresentacion" type="date" class="swal2-input m-0" style="width: 100%; box-sizing: border-box;" 
              value="${
                ronda.fechaPresentacion
                  ? ronda.fechaPresentacion.split("T")[0]
                  : ""
              }" 
              min="${
                ronda.fechaLimiteVotacion
        ...
        preConfirm: () => {
          ...
          const duracion = parseInt(
            document.getElementById("swal-duracion").value,
            10
          );
          const fechaPresentacion = document.getElementById(
            "swal-fechapresentacion"
          ).value;
          const fechaCierre = document.getElementById("swal-fechacierre").value;
          const fechaLimiteVotacion = document.getElementById(
            "swal-fechalimitevotacion"
          ).value;
    ...
    async actualizarRonda(ronda) {
      try {
        ...
        Swal.fire(
          "Actualizado",
          "La ronda ha sido actualizada con éxito",
          "success"
        );
        this.evaluarAlumnos();
      } catch (error) {
    ...
    async eliminarRonda(idRonda) {
      try {
        ...
        if (response.status === 200 || response.status === 201) {
          Swal.fire(
            "Eliminado",
            "La ronda ha sido eliminada con éxito",
            "success"
          );
        }
      ...
      servicePerf
        ...
        .then((response) => {
          ...
          const alumnos = data
            .filter(
              (entry) =>
                entry.alumno.role === "ALUMNO" &&
                entry.alumno.estadoUsuario === true
            )
            .map((entry) => ({
          ...
          const maxCharlas =
            Math.max(maxCharlasPropuestas, maxCharlasAceptadas) + 1;
          ...
          this.$nextTick(() => {
            ...
            if (ctx) {
              ...
              console.error(
                "Error: No se pudo obtener el contexto del gráfico lineal."
              );
        ...
        .then((response) => {
          ...
          this.rondasProfe.forEach((ronda) => {
            ...
            alumnos.forEach((alumno) => {
              const charlasRonda = alumno.charlas.filter(
          ...
          const labels = Object.values(charlasPorRonda).map(
            (r) => r.descripcion || `Ronda ${r.idRonda}`
          );
          const dataDoughnut = Object.values(charlasPorRonda).map(
            (r) => r.count
          );
          ...
          this.$nextTick(() => {
            ...
            if (ctx) {
              ...
              console.error(
                "Error: No se pudo obtener el contexto del gráfico doughnut."
              );
              this.loadChart = false;
            }
          });
    ...
    watch: {
      "calendarOptions.events": {
        handler(newEvents) {
          this.eventosPresentaciones = newEvents.filter(
            (evento) => evento.color === "#314B78"
          );
        },
        immediate: true,
        deep: true,
...
::v-deep(
    button.fc-today-button.fc-button.fc-button-primary:hover:not(:disabled)
  ) {
...
.list-group-item {
  ...
  gap: 40px; /* Espacia los elementos */
}
...
div:where(.swal2-container) textarea:where(.swal2-textarea):focus {
  ...
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.06),
    0 0 0 3px rgba(76, 175, 80, 0.5) !important; /* Sombra verde */
}
</style>